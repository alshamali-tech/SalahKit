...
export const TAJWEED_RULES: Readonly<Record<TajweedRuleId, TajweedRule>> = {
  ...
  qalqalah: {
    label: 'Qalqalah ṣughrā (dunyā)', arabic: 'قلقلة صغرى', category: 'qalqalah', color: 'var(--tw-qalqalah)',
    duration: null, ghunnah: false, priority: 50, style: 'recolor',
    desc: 'Lightest rank (al-dunyā): a sākin ق ط ب ج د at the END of a word, no shaddah — the ق of الْفَلَقْ.',
    descAr: 'المرتبة الدنيا: الحرف ساكنًا في آخر الكلمة غير مشدد — الْفَلَقْ',
  },
  'qalqalah-wusta': {
    ...
    desc: 'Middle rank: a sākin ق ط ب ج د in the MIDDLE of a word — the ط of يَقْطَعُونَ.',
    descAr: 'المرتبة الوسطى: الحرف ساكنًا في وسط الكلمة — يَقْطَعُونَ',
  },
  'qalqalah-kubra': {
    label: 'Qalqalah kubrā (ʿulyā)', arabic: 'قلقلة كبرى', category: 'qalqalah', color: 'var(--tw-qalqalah-kubra)',
    duration: null, ghunnah: false, priority: 56, style: 'recolor',
    desc: 'Highest rank (al-ʿulyā): a MUSHADDAH ق ط ب ج د at the end of a word — the بّ of الْحَجِّ.',
    descAr: 'المرتبة العليا: الحرف مشددًا في آخر الكلمة — الْحَجِّ',
  },
  'idgham-mutamathil': {
