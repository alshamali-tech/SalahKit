...
export const TAJWEED_CONCEPTS: readonly TajweedConcept[] = [
  ...
  },
  {
    ...
    tagline: 'The bounce of the five echoing letters.',
    points: [
      'Gather them in “Qutb Jad” — ق ط ب ج د — when they carry a sukun.',
      'Minor qalqalah mid-word (يَدْخُلُونَ), major at a stop (الْفَلَقْ).',
      'It is a light echo released from the makhraj — not a new vowel, never an extra harakah.',
      'Bouncing too hard adds a fake vowel; too soft and the letter dies.',
    ],
    letters: [
