...
export const TAJWEED_CONCEPTS: readonly TajweedConcept[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'Al-wusṭā (middle): the letter is sākin in the MIDDLE of a word — the ق of يَقْطَعُونَ.',
    ...
    practiceHint: 'The final ق of الْفَلَقِ is sākin at a word’s end (dunyā); the sukūn ق of يَقْطَعُونَ is mid-word (wusṭā); the shaddah-ed ب of وَتَبَّ is the full kubrā (ʿulyā).',
