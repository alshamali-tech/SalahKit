...
export const TAJWEED_CONCEPTS: readonly TajweedConcept[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'Idghaam only crosses a word boundary. Inside one word (الدُّنْيَا, صِنْوَانٌ) the noon stays clear — this same-word clarity is called izhār muṭlaq.',
      'Idghaam has ranks too: into م is strongest (both share a makhraj), then ن, then و and ي.',
  ...
  },
  {
    ...
    tagline: 'The bounce of the five echoing letters — judged by where you stop.',
    points: [
      'Gather them in “Qutb Jad” — ق ط ب ج د — qalqalah happens only when the letter is sākin. Ibn al-Jazarī: «وبَيِّنَنْ مُقَلْقَلًا إن سَكَّنَا ... وإن يَكُنْ في الوَقْفِ كَانَ أَبْيَنَا».',
      'Ṣughrā (lightest): sākin but NOT a stopping place — mid-word (شَقَقْنَا) or word-end while continuing (قَدْ سَمِعَ).',
      'Wusṭā (middle): sākin, no shaddah, and you STOP on it — the ق of الْفَلَقِ, لَقَدْ.',
      'Kubrā (strongest): MUSHADDAH and you STOP on it — the بّ of وَتَبَّ, الْحَقُّ. Clearest of all, being two merged letters.',
      'Letter strength (apart from the three ranks): ṭā’ is strongest, then jīm and qāf, then bā’ and dāl.',
      'The letter vibrates in its makhraj without resembling any of the three vowels — not a new harakah, never an extra vowel.',
    ],
    letters: [
      { char: 'ط', name: 'Ta · strongest' }, { char: 'ج', name: 'Jim · middle' }, { char: 'ق', name: 'Qaf · middle' },
      { char: 'ب', name: 'Ba · lightest' }, { char: 'د', name: 'Dal · lightest' },
    ],
    practice: 'قَدْ سَمِعَ ۝ قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ ۝ وَتَبَّ',
    practiceHint: 'قَدْ سَمِعَ — the د continues, so ṣughrā. Stop on the final ق of الْفَلَقِ (no shaddah) — wusṭā. Stop on the mushaddah بّ of وَتَبَّ — kubrā.',
  ...
  },
  {
    ...
    points: [
      ...
      'Sakt (ۜ) — a breath-less pause of two counts. Hafs has four: الكهف ١-٢, يس ٥٢, القيامة ٢٧, المطففين ١٤.',
    ],
